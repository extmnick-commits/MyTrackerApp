...
const styles = StyleSheet.create({
  ...
  totalSummaryLabel: { fontWeight: '600', color: '#0369a1' },
  totalSummaryValue: { fontWeight: 'bold', color: '#0369a1' },
  ...
  historyDate: { fontWeight: '700', fontSize: 16, color: '#111827' },
  mileageBadge: { backgroundColor: '#e0f2fe', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  mileageBadgeText: { color: '#0369a1', fontWeight: 'bold', fontSize: 13 },
